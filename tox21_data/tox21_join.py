...
test = pd.read_csv("tox21_10k_challenge_test.smiles", sep="\t", usecols = ['#SMILES', 'Compound Batch ID', 'NR-AR', 'NR-AR-LBD', 'NR-AhR', 'NR-ER', 'NR-ER-LBD', 'NR-PPAR-gamma', 'SR-ARE', 'SR-ATAD5', 'SR-HSE', 'SR-MMP', 'SR-p53'])
test.rename(columns = {'#SMILES':'SMILES', 'Compound Batch ID':'ID'}, inplace = True)
