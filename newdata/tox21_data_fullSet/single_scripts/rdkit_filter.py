...
# read SMILES data
mols = pd.read_csv("tox21_standardized.csv")
...
## read SMILES data
#mols = pd.read_csv("tox21_merged.csv")
...
#mols['ROMol'].replace('', np.nan, inplace=True)
#mols.dropna(subset=['ROMol'], inplace=True)
#mols = mols.drop('ROMol', axis=1)
#mols = mols.rename(columns={'SMILES': 'smiles'})
#mols.to_csv('tox21_clean_merge.csv', index=False)
