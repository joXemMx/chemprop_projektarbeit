...
def scaffold_split(data: MoleculeDataset,
    ...
    #train_pd.to_csv('/home/vo87poq/chemprop_projektarbeit/newdata/tox21_split_chemprop/train_idx.csv', index=False, header=False)
    #test_pd = pd.DataFrame(test)
    #test_pd.to_csv('/home/vo87poq/chemprop_projektarbeit/newdata/tox21_split_chemprop/test_idx.csv', index=False, header=False)
    #val_pd = pd.DataFrame(val)
    #val_pd.to_csv('/home/vo87poq/chemprop_projektarbeit/newdata/tox21_split_chemprop/val_idx.csv', index=False, header=False) 
